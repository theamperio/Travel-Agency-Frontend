...
const SAMPLE_PACKAGES: Package[] = [
  {
    ...
    description:
      "Enjoy 5 nights and 6 days in beautiful Bali with your loved one.",
    longDescription:
      "Experience the ultimate romantic getaway in the paradise island of Bali. This carefully crafted package combines luxury accommodations, private experiences, and the natural beauty of Bali.",
    ...
    itinerary: [
      {
        ...
        description:
          "Arrive at Denpasar International Airport. Private transfer to your luxury villa.",
      ...
      },
      {
        ...
        description:
          "Guided tour of Ubud. Visit the Monkey Forest and local markets.",
...
const PackageDetails: React.FC = () => {
    ...
    try {
      ...
      if (packages && !Array.isArray(packages)) {
        ...
        const selectedPackage = packages.find(
          (pkg) => pkg.id === Number(id) || pkg.packageId === id
        );
        ...
        if (selectedPackage) {
          ...
          const samplePackage = SAMPLE_PACKAGES.find(
            (pkg) => pkg.id === Number(id) || pkg.packageId === id
          );
          if (samplePackage) {
  ...
  const handleViewOnMap = () => {
    ...
    setTimeout(() => {
      locationTabRef.current?.scrollIntoView({
        behavior: "smooth",
        block: "start",
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[50vh] md:h-[70vh] overflow-hidden">
        ...
        {/* Navigation Arrows */}
        {currentPackage?.images && currentPackage.images.length > 1 && (
          <>
            <button
            ...
            <div className="flex items-center">
              <div className="flex items-center">
                ...
                <span className="text-white/70 ml-1">
                  ({currentPackage?.reviewCount} reviews)
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex space-x-3 overflow-x-auto hide-scrollbar pb-2">
              {currentPackage.images.map((image, index) => (
                <motion.button
                  ...
                  whileHover={{
                    scale: activeImageIndex === index ? 1.05 : 1.02,
                  }}
                >
                  <img
                    src={image}
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                        {currentPackage?.amenities?.map((amenity, index) => (
                          ...
                          >
                            <i
                              className={`fas fa-${amenity.icon} text-blue-600 text-xl w-8 text-center mr-3`}
                            ></i>
                    ...
                    <div>
                      ...
                      <div className="relative mt-8 pl-8 border-l-2 border-gray-200">
                        {currentPackage?.itinerary.map((day, index) => (
                          ...
                          >
                            <div
                              className={`absolute -left-10 w-6 h-6 rounded-full border-2 ${
                                activeItineraryDay === day.day
                    ...
                    <div>
                      ...
                      {currentPackage?.destination ? (
                        <div ref={locationTabRef}>
                          ...
                          <p className="text-gray-700 mb-4">
                            Explore the location of{" "}
                            <strong>{currentPackage.title}</strong> in{" "}
                            <strong>{currentPackage.destination}</strong>.
                          </p>
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            Note: This is an embedded map for general location.
                            For precise details or navigation, please use a
                            dedicated map service.
                          </p>
                        </div>
                      ) : (
                        <p className="text-gray-700">
                          Location information is not available for this
                          package.
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-6">
                        <div className="border-b border-gray-100 pb-6">
                          ...
                          <p className="text-gray-700">
                            This was the perfect honeymoon package! Everything
                            was well organized and the villa was absolutely
                            stunning. The sunset dinner cruise was the highlight
                            of our trip.
                          </p>
                        </div>
                        ...
                        <div className="border-b border-gray-100 pb-6">
                          ...
                          <p className="text-gray-700">
                            We had an amazing time in Bali. The accommodations
                            were luxurious and the staff was very attentive. The
                            only small issue was that one of our tours started a
                            bit late, but it was still a wonderful experience
                            overall.
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-gray-700">
                            This package exceeded our expectations. The private
                            villa was secluded and romantic, and the spa
                            treatment was incredibly relaxing. We'll definitely
                            book with this company again for our next trip.
                          </p>
                        </div>
                      </div>
